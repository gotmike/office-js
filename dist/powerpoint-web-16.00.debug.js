...
!function(e) {
    ...
    var r = n(1), o = n(2), i = n(3), u = n(5), c = n(6);
    window._OfficeRuntimeWeb = {
        displayWebDialog: i.displayWebDialog,
        AsyncStorage: o,
        storage: u.storage,
    ...
    t.Dialog = o, t.displayWebDialog = function(e, t) {
        return new r.CoreUtility.Promise(function(n, i) {
            if (t.width && t.height && (!s(t.width) || !s(t.height))) throw new r.Error({
            ...
            Office.context.ui.displayDialogAsync(e, c, function(e) {
                ...
                u.addEventHandler(Office.EventType.DialogEventReceived, f), n(new o(u)));
            });
        });
    };
}, function(e, t) {
    ...
    var r = function() {
        ...
        return e.prototype.getBooleanFeatureGate = function(e, t) {
            try {
                ...
                return void 0 === n || null === n ? t : "true" === n.toString().toLowerCase();
            } catch (e) {
                return t;
            }
...
window.OfficeRuntime = {...(window as any).OfficeRuntime, ...window._OfficeRuntimeWeb};