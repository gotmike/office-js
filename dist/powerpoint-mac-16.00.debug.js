...
!function(e) {
    ...
    var r = n(2), o = n(3), i = n(5), u = n(6), c = n(7), a = n(8), s = n(9);
    window._useSDXSandbox ? window._OfficeRuntimeNative = {
        ...
        storage: a.storage,
        experimentation: s.experimentation,
        apiInformation: r.apiInformation
    };
}, function(e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
    ...
    t.Dialog = o, t.displayWebDialog = function(e, t) {
        return new r.CoreUtility.Promise(function(n, i) {
            if (t.width && t.height && (!l(t.width) || !l(t.height))) throw new r.Error({
            ...
            function s(e) {
                12006 === e.error ? t.onClose && t.onClose() : t.onRuntimeError && t.onRuntimeError(new r.Error(f(e.error)), u);
            }
            function l(e) {
                return /^(\-|\+)?([0-9]+)%?$/.test(e);
            }
            ...
            Office.context.ui.displayDialogAsync(e, c, function(e) {
                "failed" === e.status ? i(new r.Error(f(e.error.code))) : ((u = e.value).addEventHandler(Office.EventType.DialogMessageReceived, a), 
    ...
    var m = function() {
        ...
        return o(t, e), Object.defineProperty(t.prototype, "_className", {
            ...
            e.prototype._handleResult.call(this, t), a(t) || l(this, t);
