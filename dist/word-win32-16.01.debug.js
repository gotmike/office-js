...
// runtime: 16.0.12111.30007
// core: 16.0\12118.10000
// host: 16.0\12118.10000
...
(function (OSFAppTelemetry) {
	...
	function initialize(context) {
		...
		appInfo.hostJSVersion="16.0.12118.10000";
...
(function (Word) {
	...
	var Body=(function (_super) {
		...
		Object.defineProperty(Body.prototype, "_scalarPropertyOriginalNames", {
			get: function () {
				return ["_ReferenceId", "Style", "Text", "Type", "StyleBuiltIn"];
			},
			enumerable: true,
		...
		Body.prototype.setMockData=function (data) {
			_setMockData(this, data);
		};
	...
	var ContentControl=(function (_super) {
		...
		Object.defineProperty(ContentControl.prototype, "_scalarPropertyOriginalNames", {
			get: function () {
				return ["Id", "_ReferenceId", "Title", "Tag", "PlaceholderText", "Type", "Appearance", "Color", "RemoveWhenEdited", "CannotDelete", "CannotEdit", "Style", "Text", "Subtype", "StyleBuiltIn"];
			},
			enumerable: true,
		...
		ContentControl.prototype.setMockData=function (data) {
			_setMockData(this, data);
		};
	...
	var ContentControlCollection=(function (_super) {
		...
		Object.defineProperty(ContentControlCollection.prototype, "_scalarPropertyOriginalNames", {
			get: function () {
				return ["_ReferenceId"];
			},
			enumerable: true,
		...
		ContentControlCollection.prototype.setMockData=function (data) {
			var _this=this;
			_setMockData(this, data, function (childItemData, index) { return _createChildItemObject(Word.ContentControl, true, _this, childItemData, index); }, function (items) { return _this.m__items=items; });
		};
		return ContentControlCollection;
	}(OfficeExtension.ClientObject));
	...
	var CustomPropertyCollection=(function (_super) {
		...
		Object.defineProperty(CustomPropertyCollection.prototype, "_scalarPropertyOriginalNames", {
			get: function () {
				return ["_ReferenceId"];
			},
			enumerable: true,
		...
		CustomPropertyCollection.prototype.setMockData=function (data) {
			var _this=this;
			_setMockData(this, data, function (childItemData, index) { return _createChildItemObject(Word.CustomProperty, true, _this, childItemData, index); }, function (items) { return _this.m__items=items; });
		};
		return CustomPropertyCollection;
	}(OfficeExtension.ClientObject));
	...
	var DocumentCreated=(function (_super) {
		...
		Object.defineProperty(DocumentCreated.prototype, "_scalarPropertyOriginalNames", {
			get: function () {
				return ["Saved", "_ReferenceId"];
			},
			enumerable: true,
		...
		DocumentCreated.prototype.setMockData=function (data) {
			_setMockData(this, data);
		};
	...
	var Font=(function (_super) {
		...
		Object.defineProperty(Font.prototype, "_scalarPropertyOriginalNames", {
			get: function () {
				return ["_ReferenceId", "Name", "Size", "Bold", "Italic", "Color", "Underline", "Subscript", "Superscript", "StrikeThrough", "DoubleStrikeThrough", "HighlightColor"];
			},
			enumerable: true,
		...
		Font.prototype.setMockData=function (data) {
			_setMockData(this, data);
		};
	...
	var InlinePicture=(function (_super) {
		...
		Object.defineProperty(InlinePicture.prototype, "_scalarPropertyOriginalNames", {
			get: function () {
				return ["_Id", "_ReferenceId", "AltTextDescription", "AltTextTitle", "Height", "Hyperlink", "LockAspectRatio", "Width"];
			},
			enumerable: true,
		...
		InlinePicture.prototype.setMockData=function (data) {
			_setMockData(this, data);
		};
	...
	var InlinePictureCollection=(function (_super) {
		...
		Object.defineProperty(InlinePictureCollection.prototype, "_scalarPropertyOriginalNames", {
			get: function () {
				return ["_ReferenceId"];
			},
			enumerable: true,
		...
		InlinePictureCollection.prototype.setMockData=function (data) {
			var _this=this;
			_setMockData(this, data, function (childItemData, index) { return _createChildItemObject(Word.InlinePicture, true, _this, childItemData, index); }, function (items) { return _this.m__items=items; });
		};
		return InlinePictureCollection;
	}(OfficeExtension.ClientObject));
	...
	var List=(function (_super) {
		...
		Object.defineProperty(List.prototype, "_scalarPropertyOriginalNames", {
			get: function () {
				return ["Id", "_ReferenceId", "LevelTypes", "LevelExistences"];
			},
			enumerable: true,
		...
		List.prototype.setMockData=function (data) {
			_setMockData(this, data);
		};
	...
	var ListCollection=(function (_super) {
		...
		Object.defineProperty(ListCollection.prototype, "_scalarPropertyOriginalNames", {
			get: function () {
				return ["_ReferenceId"];
			},
			enumerable: true,
		...
		ListCollection.prototype.setMockData=function (data) {
			var _this=this;
			_setMockData(this, data, function (childItemData, index) { return _createChildItemObject(Word.List, true, _this, childItemData, index); }, function (items) { return _this.m__items=items; });
		};
		return ListCollection;
	}(OfficeExtension.ClientObject));
	...
	var ListItem=(function (_super) {
		...
		Object.defineProperty(ListItem.prototype, "_scalarPropertyOriginalNames", {
			get: function () {
				return ["_ReferenceId", "SiblingIndex", "ListString", "Level"];
			},
			enumerable: true,
		...
		ListItem.prototype.setMockData=function (data) {
			_setMockData(this, data);
		};
	...
	var Paragraph=(function (_super) {
		...
		Paragraph.prototype.getSubrange=function (start, length) {
			...
			return _createMethodObject(Word.Range, this, "GetSubrange", 1, [start, length], false, false, null, 4);
		};
	...
	var ParagraphCollection=(function (_super) {
		...
		ParagraphCollection.prototype.setMockData=function (data) {
			var _this=this;
			_setMockData(this, data, function (childItemData, index) { return _createChildItemObject(Word.Paragraph, true, _this, childItemData, index); }, function (items) { return _this.m__items=items; });
		};
		return ParagraphCollection;
	}(OfficeExtension.ClientObject));
	...
	var Range=(function (_super) {
		...
		Range.prototype.endPreview=function () {
			_invokeMethod(this, "EndPreview", 1, [], 4, 0);
		};
		...
		Range.prototype.highlight=function (color) {
			_invokeMethod(this, "Highlight", 1, [color], 4, 0);
		};
		...
		Range.prototype.previewTextReplacement=function (replacement) {
			_invokeMethod(this, "PreviewTextReplacement", 1, [replacement], 4, 0);
		};
		Range.prototype.removeHighlight=function () {
			_invokeMethod(this, "RemoveHighlight", 1, [], 4, 0);
		};
	...
	var RangeCollection=(function (_super) {
		...
		Object.defineProperty(RangeCollection.prototype, "_scalarPropertyOriginalNames", {
			get: function () {
				return ["_ReferenceId"];
			},
			enumerable: true,
		...
		RangeCollection.prototype.setMockData=function (data) {
			var _this=this;
			_setMockData(this, data, function (childItemData, index) { return _createChildItemObject(Word.Range, true, _this, childItemData, index); }, function (items) { return _this.m__items=items; });
		};
		return RangeCollection;
	}(OfficeExtension.ClientObject));
	...
	var SearchOptions=(function (_super) {
		...
		Object.defineProperty(SearchOptions.prototype, "_scalarPropertyOriginalNames", {
			get: function () {
				return ["IgnorePunct", "IgnoreSpace", "MatchCase", "MatchPrefix", "MatchSuffix", "MatchWildcards", "MatchWholeWord"];
			},
			enumerable: true,
		...
		SearchOptions.prototype.setMockData=function (data) {
			_setMockData(this, data);
		};
	...
	var SectionCollection=(function (_super) {
		...
		SectionCollection.prototype.setMockData=function (data) {
			var _this=this;
			_setMockData(this, data, function (childItemData, index) { return _createChildItemObject(Word.Section, true, _this, childItemData, index); }, function (items) { return _this.m__items=items; });
		};
		return SectionCollection;
	}(OfficeExtension.ClientObject));
	...
	var TableCollection=(function (_super) {
		...
		TableCollection.prototype.setMockData=function (data) {
			var _this=this;
			_setMockData(this, data, function (childItemData, index) { return _createChildItemObject(Word.Table, true, _this, childItemData, index); }, function (items) { return _this.m__items=items; });
		};
		return TableCollection;
	}(OfficeExtension.ClientObject));
	...
	var TableRowCollection=(function (_super) {
		...
		TableRowCollection.prototype.setMockData=function (data) {
			var _this=this;
			_setMockData(this, data, function (childItemData, index) { return _createChildItemObject(Word.TableRow, true, _this, childItemData, index); }, function (items) { return _this.m__items=items; });
		};
		return TableRowCollection;
	}(OfficeExtension.ClientObject));
	...
	var TableCellCollection=(function (_super) {
		...
		TableCellCollection.prototype.setMockData=function (data) {
			var _this=this;
			_setMockData(this, data, function (childItemData, index) { return _createChildItemObject(Word.TableCell, true, _this, childItemData, index); }, function (items) { return _this.m__items=items; });
		};
		return TableCellCollection;
	}(OfficeExtension.ClientObject));
	...
	var TableBorder=(function (_super) {
		...
		Object.defineProperty(TableBorder.prototype, "_scalarPropertyOriginalNames", {
			get: function () {
				return ["_ReferenceId", "Color", "Type", "Width"];
			},
			enumerable: true,
		...
		TableBorder.prototype.setMockData=function (data) {
			_setMockData(this, data);
		};
...
!function(e) {
    ...
    var n = r(2), o = r(4), i = r(5), c = r(6);
    window._OfficeRuntimeNative = {
        displayWebDialog: o.displayWebDialog,
        AsyncStorage: i.AsyncStorage,
        storage: i.storage,
        experimentation: c.experimentation,
        apiInformation: n.apiInformation
    };
}, function(e, t, r) {
    "use strict";
    (function(e) {
        function r(e) {
            var r, t = e.split("."), n = 0, o = 0;
            if (t.length < 2 && isNaN(Number(e))) throw "version format incorrect";
            if (r = Number(t[0]), t.length >= 2 && (n = Number(t[1])), t.length >= 3 && (o = Number(t[2])), 
            isNaN(r) || isNaN(n) || isNaN(o)) throw "version format incorrect";
            return {
                major: r,
                minor: n,
                patch: o
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            isSetSupported: function(t, n) {
                ...
                if (i > -1) {
                    var c = o[Object.keys(o)[i]];
                    try {
                        var s, a = r(n);
                        if ((s = Array.isArray(c) ? function(e, t) {
    ...
    var i = r(0), c = (i.BatchApiHelper.createPropertyObject, i.BatchApiHelper.createMethodObject, 
    i.BatchApiHelper.createIndexerObject, i.BatchApiHelper.createRootServiceObject, 
    i.BatchApiHelper.createTopLevelServiceObject), a = (i.BatchApiHelper.createChildItemObject, 
    i.BatchApiHelper.invokeMethod), s = (i.BatchApiHelper.invokeEnsureUnchanged, i.BatchApiHelper.invokeSetProperty, 
    i.Utility.isNullOrUndefined), u = (i.Utility.isUndefined, i.Utility.throwIfNotLoaded, 
    i.Utility.throwIfApiNotSupported, i.Utility.load, i.Utility.retrieve, i.Utility.toJson), l = i.Utility.fixObjectPathIfNecessary, f = (i.Utility._handleNavigationPropertyResults, 
    i.Utility.adjustToDateTime, i.Utility.processRetrieveResult), p = (i.Utility.setMockData, 
    function() {
        function e(e) {
    ...
    t.Dialog = p, t.displayWebDialog = function(e, t) {
        return void 0 === t && (t = {}), new i.CoreUtility.Promise(function(n, o) {
            if (t.width && t.height && (!r(t.width) || !r(t.height))) throw new i.Error({
                code: "InvalidArgument",
                message: 'Dimensions must be "number%" or number.'
            });
            var c = new i.ClientRequestContext(), a = g.newObject(c), s = new p(a), u = a.onDialogMessage.add(function(e) {
                switch (i.Utility.log("dialogMessageHandler:" + JSON.stringify(e)), e.type) {
                  case 17:
                    e.error ? o(e.error) : n(s);
                    break;
                  ...
                  case 10:
                  default:
                    12006 === e.originalErrorCode ? (u && (u.remove(), c.sync()), t.onClose && t.onClose()) : t.onRuntimeError && (t.onRuntimeError(e.error, s), 
                    o(e.error));
                }
                return i.CoreUtility.Promise.resolve();
            });
            return c.sync().then(function() {
                ...
                return a.displayDialog(e, r), c.sync();
            }).catch(function(e) {
                o(e);
            });
        });
    ...
    var d, g = function(e) {
        ...
        return o(t, e), Object.defineProperty(t.prototype, "_className", {
            ...
            a(this, "DisplayDialog", 1, [ e, t ], 4, 0);
            ...
            return c(t, e, "Microsoft.Dialog.DialogService", !1, 4);
        }, Object.defineProperty(t.prototype, "onDialogMessage", {
            get: function() {
                return this.m_dialogMessage || (this.m_dialogMessage = new i.GenericEventHandlers(this.context, this, "DialogMessage", {
                    eventType: 65536,
                    registerFunc: function() {},
                    unregisterFunc: function() {},
                    ...
                    eventArgsTransformFunc: function(e) {
                        var t, r, n, o;
                        try {
                            var c = JSON.parse(e.message), a = c.errorCode ? new i.Error((r = c.errorCode, (n = {})[12002] = {
                                code: "InvalidUrl",
    ...
    t.DialogService = g, function(e) {
        e[e.dialogMessageReceived = 0] = "dialogMessageReceived", e[e.dialogEventReceived = 1] = "dialogEventReceived";
    }(d || (d = {})), (t.DialogErrorCodes || (t.DialogErrorCodes = {})).generalException = "GeneralException";
}, function(e, t, r) {
    "use strict";
    var n, o = this && this.__extends || (n = function(e, t) {
        return (n = Object.setPrototypeOf || {
    ...
    function p(e, t) {
        return new i.CoreUtility.Promise(function(r, n) {
            var o = g.getInstance(), i = o.setCallBack(function(e, o) {
                if (o) n(o); else {
                    var i = t(e);
                    r(i);
                }
    ...
    function d(e, t, r) {
        return new i.CoreUtility.Promise(function(n, o) {
            var i = g.getInstance(), c = i.setCallBack(function(e, i) {
                if (i) return r && r(i), void o(i);
                var c = t(e);
                r && r(null, c), n(c);
            });
            i.ctx.sync().then(function() {
                var t = i.getPersistentKvStorageService();
                return e(t, c), i.ctx.sync();
            }).catch(function(e) {
                o(e);
            });
        });
    ...
    var g = function() {
        ...
        return o(t, e), Object.defineProperty(t.prototype, "_className", {
            ...
            a(this, "Clear", 1, [ e ], 4, 0);
        }, t.prototype.getAllKeys = function(e) {
            a(this, "GetAllKeys", 1, [ e ], 4, 0);
        }, t.prototype.multiGet = function(e, t) {
            a(this, "MultiGet", 1, [ e, t ], 4, 0);
        }, t.prototype.multiRemove = function(e, t) {
            a(this, "MultiRemove", 1, [ e, t ], 4, 0);
        }, t.prototype.multiSet = function(e, t) {
            a(this, "MultiSet", 1, [ e, t ], 4, 0);
        }, t.prototype._handleResult = function(t) {
            e.prototype._handleResult.call(this, t), s(t) || l(this, t);
        }, t.prototype._handleRetrieveResult = function(t, r) {
            e.prototype._handleRetrieveResult.call(this, t, r), f(this, t, r);
        }, t.newObject = function(e) {
            return c(t, e, "Microsoft.PersistentKvStorage.PersistentKvStorageService", !1, 4);
            ...
            get: function() {
                return this.m_persistentStorageMessage || (this.m_persistentStorageMessage = new i.GenericEventHandlers(this.context, this, "PersistentStorageMessage", {
                    ...
                    eventArgsTransformFunc: function(e) {
                        var t, r, n, o;
                        try {
                            var c = JSON.parse(e.message), a = parseInt(c.errorCode), s = 0 != a ? new i.Error((r = a, 
                            (n = {})[16389] = {
                                code: "GenericException",
                                message: "Unknown error."
                            }, n[65535] = {
        ...
        return e.prototype.getBooleanFeatureGate = function(e, t) {
            ...
            return n(this, void 0, void 0, function() {
                ...
                return o(this, function(o) {
                    switch (o.label) {
                      case 0:
                        return o.trys.push([ 0, 2, , 3 ]), r = this.getRequestContext(), n = r.flighting.getFeature(e, "Boolean", t), 
                        r.load(n), [ 4, r.sync() ];

                      case 1:
                        return o.sent(), [ 2, n.value ];
            ...
            return n(this, void 0, void 0, function() {
                ...
                return o(this, function(o) {
                    switch (o.label) {
                      case 0:
                        return o.trys.push([ 0, 2, , 3 ]), r = this.getRequestContext(), n = r.flighting.getFeature(e, "String", t), 
                        r.load(n), [ 4, r.sync() ];
            ...
            return n(this, void 0, void 0, function() {
                ...
                return o(this, function(o) {
                    switch (o.label) {
                      case 0:
                        return o.trys.push([ 0, 2, , 3 ]), r = this.getRequestContext(), n = r.flighting.getFeature(e, "Integer", t), 
                        r.load(n), [ 4, r.sync() ];
...
window.OfficeRuntime = {...(window as any).OfficeRuntime, ...window._OfficeRuntimeNative};