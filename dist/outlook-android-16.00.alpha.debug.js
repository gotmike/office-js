...
/* office-js-api version: 20190920.7 */
/*
...
var ExtensibilityStrings_OSF = __webpack_require__(0);
...
function loadStrings() {
  // TODO: Add support for Promises in IE
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          /*break*/
          , 2];
          ExtensibilityStrings_OSF.OUtil.loadScript(url, stringLoadedCallback, 1000);

          if (document.querySelectorAll("script[src=\"" + url + "\"]").length <= 0) {
            fallbackUrl = baseUrl + "en-us/" + ExtensibilityStringJS;
            ExtensibilityStrings_OSF.OUtil.loadScript(fallbackUrl, stringLoadedCallback, 1000);
          }
...
function initialize() {
  ...
  , "AttachmentSizeExceeded", getString("l_AttachmentExceededSize_Text"));
  addErrorMessage(9001
  /* NumberOfAttachmentsExceeded */
  , "NumberOfAttachmentsExceeded", getString("l_ExceededMaxNumberOfAttachments_Text"));
  addErrorMessage(9002
  /* InternalFormatError */
  , "InternalFormatError", getString("l_InternalFormatError_Text"));
  addErrorMessage(9003
  /* InvalidAttachmentId */
  , "InvalidAttachmentId", getString("l_InvalidAttachmentId_Text"));
  addErrorMessage(9004
  /* InvalidAttachmentPath */
  , "InvalidAttachmentPath", getString("l_InvalidAttachmentPath_Text"));
  addErrorMessage(9005
  /* CannotAddAttachmentBeforeUpgrade */
  , "CannotAddAttachmentBeforeUpgrade", getString("l_CannotAddAttachmentBeforeUpgrade_Text"));
  addErrorMessage(9006
  /* AttachmentDeletedBeforeUploadCompletes */
  , "AttachmentDeletedBeforeUploadCompletes", getString("l_AttachmentDeletedBeforeUploadCompletes_Text"));
  addErrorMessage(9007
  /* AttachmentUploadGeneralFailure */
  , "AttachmentUploadGeneralFailure", getString("l_AttachmentUploadGeneralFailure_Text"));
  addErrorMessage(9008
  /* AttachmentToDeleteDoesNotExist */
  , "AttachmentToDeleteDoesNotExist", getString("l_DeleteAttachmentDoesNotExist_Text"));
  addErrorMessage(9009
  /* AttachmentDeleteGeneralFailure */
  , "AttachmentDeleteGeneralFailure", getString("l_AttachmentDeleteGeneralFailure_Text"));
  addErrorMessage(9010
  /* InvalidEndTime */
  , "InvalidEndTime", getString("l_InvalidEndTime_Text"));
  addErrorMessage(9011
  /* HtmlSanitizationFailure */
  , "HtmlSanitizationFailure", getString("l_HtmlSanitizationFailure_Text"));
  addErrorMessage(9012
  /* NumberOfRecipientsExceeded */
  , "NumberOfRecipientsExceeded", getString("l_NumberOfRecipientsExceeded_Text").replace("{0}", totalRecipientsLimit));
  addErrorMessage(9013
  /* NoValidRecipientsProvided */
  , "NoValidRecipientsProvided", getString("l_NoValidRecipientsProvided_Text"));
  addErrorMessage(9014
  /* CursorPositionChanged */
  , "CursorPositionChanged", getString("l_CursorPositionChanged_Text"));
  addErrorMessage(9016
  /* InvalidSelection */
  , "InvalidSelection", getString("l_InvalidSelection_Text"));
  ...
  /* SaveError */
  , "SaveError", getString("l_SaveError_Text"));
  addErrorMessage(9022
  /* MessageInDifferentStoreError */
  , "MessageInDifferentStoreError", getString("l_MessageInDifferentStoreError_Text"));
  addErrorMessage(9023
  /* DuplicateNotificationKey */
  , "DuplicateNotificationKey", getString("l_DuplicateNotificationKey_Text"));
  addErrorMessage(9024
  /* NotificationKeyNotFound */
  , "NotificationKeyNotFound", getString("l_NotificationKeyNotFound_Text"));
  addErrorMessage(9025
  /* NumberOfNotificationsExceeded */
  , "NumberOfNotificationsExceeded", getString("l_NumberOfNotificationsExceeded_Text"));
  addErrorMessage(9026
  /* PersistedNotificationArrayReadError */
  , "PersistedNotificationArrayReadError", getString("l_PersistedNotificationArrayReadError_Text"));
  addErrorMessage(9027
  /* PersistedNotificationArraySaveError */
  , "PersistedNotificationArraySaveError", getString("l_PersistedNotificationArraySaveError_Text"));
  addErrorMessage(9028
  /* CannotPersistPropertyInUnsavedDraftError */
  , "CannotPersistPropertyInUnsavedDraftError", getString("l_CannotPersistPropertyInUnsavedDraftError_Text"));
  addErrorMessage(9029
  /* CallSaveAsyncBeforeToken */
  , "CanOnlyGetTokenForSavedItem", getString("l_CallSaveAsyncBeforeToken_Text"));
  addErrorMessage(9030
  /* APICallFailedDueToItemChange */
  , "APICallFailedDueToItemChange", getString("l_APICallFailedDueToItemChange_Text"));
  addErrorMessage(9031
  /* InvalidParameterValueError */
  , "InvalidParameterValueError", getString("l_InvalidParameterValueError_Text"));
  addErrorMessage(9033
  /* SetRecurrenceOnInstance */
  , "SetRecurrenceOnInstanceError", getString("l_Recurrence_Error_Instance_SetAsync_Text"));
  addErrorMessage(9034
  /* InvalidRecurrence */
  , "InvalidRecurrenceError", getString("l_Recurrence_Error_Properties_Invalid_Text"));
  addErrorMessage(9035
  /* RecurrenceZeroOccurrences */
  , "RecurrenceZeroOccurrences", getString("l_RecurrenceErrorZeroOccurrences_Text"));
  addErrorMessage(9036
  /* RecurrenceMaxOccurrences */
  , "RecurrenceMaxOccurrences", getString("l_RecurrenceErrorMaxOccurrences_Text"));
  addErrorMessage(9037
  /* RecurrenceInvalidTimeZone */
  , "RecurrenceInvalidTimeZone", getString("l_RecurrenceInvalidTimeZone_Text"));
  addErrorMessage(9038
  /* InsufficientItemPermissions */
  , "InsufficientItemPermissionsError", getString("l_Insufficient_Item_Permissions_Text"));
  addErrorMessage(9039
  /* RecurrenceUnsupportedAlternateCalendar */
  , "RecurrenceUnsupportedAlternateCalendar", getString("l_RecurrenceUnsupportedAlternateCalendar_Text"));
  addErrorMessage(9040
  /* OlkHTTPError */
  , "HTTPRequestFailure", getString("l_Olk_Http_Error_Text"));
  addErrorMessage(9041
  /* OlkInternetNotConnectedError */
  , "NetworkError", getString("l_Internet_Not_Connected_Error_Text"));
  addErrorMessage(9042
  /* OlkInternalServerError */
  , "InternalServerError", getString("l_Internal_Server_Error_Text"));
  addErrorMessage(9043
  /* AttachmentTypeNotSupported */
  , "AttachmentTypeNotSupported", getString("l_AttachmentNotSupported_Text"));
  addErrorMessage(9044
  /* OlkInvalidCategoryError */
  , "InvalidCategory", getString("l_Invalid_Category_Error_Text"));
  addErrorMessage(9045
  /* DuplicateCategoryError */
  , "DuplicateCategory", getString("l_Duplicate_Category_Error_Text"));
  addErrorMessage(9046
  /* ItemNotSavedError */
  , "ItemNotSaved", getString("l_Item_Not_Saved_Error_Text"));
  isInitialized = true;
}
...
function handleTokenResponse(response, context, resultCode) {
  ...
  if (!!resultCode && resultCode !== InvokeResultCode.noError) {
    ...
    /* AccessRestricted */
    , context, getString("l_InternalProtocolError_Text").replace("{0}", resultCode));
  } else {
...
function handleCustomResponse(data, context, responseCode) {
  if (!!responseCode && responseCode !== InvokeResultCode.noError) {
    ...
    /* AccessRestricted */
    , context, getString("l_InternalProtocolError_Text").replace("{0}", responseCode));
  ...
  CustomProperties.prototype.get = function (key) {
    ...
    if (typeof value === "string") {
      ...
      if (valueString.length > DatePrefix.length + DatePostfix.length && valueString.startsWith(DatePrefix) && valueString.endsWith(DatePostfix)) {
        ...
        var ticks = Number.parseInt(ticksString);
...
function getMessageRead() {
  ...
  var messageRead = objectDefine({}, {
    ...
    getEntitiesByType: function getEntitiesByType() {},
    getFilteredEntitiesByName: function getFilteredEntitiesByName() {},
    getInitializationContextAsync: getInitializationContext,
    getRegExMatches: function getRegExMatches() {},
    getRegExMatchesByName: function getRegExMatchesByName() {},
    getSelectedEntities: function getSelectedEntities() {},
    getSelectedRegExMatches: function getSelectedRegExMatches() {},
...
function () {
  ...
  SeriesTime.prototype.setStartTime = function (hoursOrTimeString, minutes) {
    if (!isNullOrUndefined(hoursOrTimeString) && !isNullOrUndefined(minutes)) {
      ...
      if (!isNullOrUndefined(dateObject) && !Number.isNaN(dateObject.getUTCHours()) && !Number.isNaN(dateObject.getUTCMinutes())) {
  ...
  SeriesTime.prototype.setDateHelper = function (isStart, yearOrDateString, month, day) {
    ...
    if (yearOrDateString !== null && !isNullOrUndefined(month) && day !== null) {
      ...
      if (dateObject !== null && !Number.isNaN(dateObject.getUTCFullYear()) && !Number.isNaN(dateObject.getUTCMonth()) && !Number.isNaN(dateObject.getUTCDate())) {
...
function convertToUtcClientTime(input) {
  ...
  if (getInitialDataProp("timeZoneOffsets") !== null) {
    ...
    offset = input["timezoneOffset"] === null ? retValue.getTimezoneOffset() * -1 : input["timezoneOffset"];
    retValue.setUTCMinutes(retValue.getUTCMinutes() + offset);
  }
...
function localClientTimeToDate(input) {
  ...
  if (Number.isNaN(retValue.getTime())) {
    throw createArgumentError("input", getString("l_InvalidDate_Text"));
  }
...
/// <remarks>Exposed for unit tests.</remarks>
var isOutlook16OrGreater = function isOutlook16OrGreater(hostVersion) {
  ...
  if (hostVersion != null) {
    ...
    majorVersionNumber = Number.parseInt(hostVersion.substring(0, endIndex));
  }
...
var isApiVersionSupported = function isApiVersionSupported(requirementSet, officeAppContext) {
  ...
  try {
    ...
    if (Number.parseInt(hostApiVersionParts[0]) > Number.parseInt(requirementSetParts[0]) || Number.parseInt(hostApiVersionParts[0]) === Number.parseInt(requirementSetParts[0]) && Number.parseInt(hostApiVersionParts[1]) >= Number.parseInt(requirementSetParts[1])) {
      apiSupported = true;
    }
...
var OutlookAppOm_OSF = __webpack_require__(0); /// <reference types="../types/external" />
  ...
  function OutlookAppOm(appContext, targetWindow, appReadyCallback) {
    ...
    this.initialize = function (data) {
      ...
      if (data === null) {
        ...
        var supportsAdditionalParameters = getAppName() !== OutlookAppOm_OSF.AppName.Outlook || isOutlook16OrGreater(getInitialDataProp("hostVersion")) || isApiVersionSupported("1.5", _this.officeAppContext);
...
var saveSettingsRequest_OSF = __webpack_require__(0); /// <summary>
...
var Settings_OSF = __webpack_require__(0); /// <summary>
...
var Intellisense = {
  //TODO: Add the intellisense and validation logic
